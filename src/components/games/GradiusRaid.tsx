...
type MesiahScoutUnit = MesiahDroneUnit & {
  stack: number
}

type SpiegelAfterimage = Vec & {
  life: number
}
...
const GOD_GUNDAM_BARRAGE_BURNING_RAGE_DAMAGE_MULTIPLIER = 0.55
const GOD_GUNDAM_MELEE_RANGE = 29
const GOD_GUNDAM_MELEE_BURNING_RANGE_BONUS = 4
...
function createMesiahScoutDrones(x = 50, y = 82): MesiahScoutUnit[] {
...
function normalizeMesiahScoutDrones(player: Player) {
...
function getOptionSupportStacks(player: Player) {
...
function updatePlayerTimers(player: Player, dt: number, enemies: Enemy[], isSmallViewport: boolean) {
...
function getMesiahScoutSupportPoint(
  player: Player,
  side: number,
  elapsed: number,
  isSmallViewport: boolean,
...
function updateMesiahScoutDrones(player: Player, enemies: Enemy[], dt: number, isSmallViewport: boolean) {
...
function drawSupportEngineTrail(ctx: CanvasRenderingContext2D, x: number, y: number, size: number, time: number, rotation = 0, alpha = 0.82, shipKey = '') {
...
function getCoreBlastSprite(radius: number, burning: boolean, frameBucket: number) {
...
function drawSingleMasteryEngineTrail(ctx: CanvasRenderingContext2D, x: number, y: number, size: number, time: number, color: string, shipKey: string, engineBoost = 0) {
